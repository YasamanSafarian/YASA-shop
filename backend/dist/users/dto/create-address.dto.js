...
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.Matches)(/^[0-9+\- ]{6,20}$/, {
        message: 'receiverPhone must contain only digits, +, - and spaces (6-20 characters)',
    }),
    __metadata("design:type", String)
], CreateAddressDto.prototype, "receiverPhone", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
...
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.Matches)(/^[0-9a-zA-Z\- ]{3,20}$/, {
